    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="icons">
                ...
                @if (Session::has('user'))
                    {{-- <a href="{{route('LogUser.index')}}" class="icons-btn d-inline-block has-children" style="margin-left: 25px">
                        <span class="icon-user" style="font-size: 20px"></span>
                    </a> --}}
                    <div class='dropdown  d-inline-block bag' style='margin-left:20px'>
                        <span class='btn btn-secondary dropdown-toggle' type='button' id='dropdownMenuButton2'
                            data-toggle='dropdown' aria-expanded='false'>
                            <span class="icon-user" style="font-size: 20px">
                                {{-- <img src='' style='width:25px;height:25px' class='d-inline-block rounded-circle' /> --}}
                            </span>
                        </span>
                        <ul class='dropdown-menu dropdown-menu-dark' aria-labelledby='dropdownMenuButton2'>
                            <li><a class='dropdown-item' href='{{ route('LogUser.index') }}'>Settings</a></li>
                            <li>
                                <hr class='dropdown-divider'>
                            </li>
                            <li><a href='{{ url('/Account/Logout') }}' class='dropdown-item'><span>LogOut</span></a> </li>
                        </ul>
                    </div>
