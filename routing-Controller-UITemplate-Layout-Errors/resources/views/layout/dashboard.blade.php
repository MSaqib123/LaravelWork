...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/feather/feather.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/typicons/typicons.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/simple-line-icons/css/simple-line-icons.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{url('/Dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}">
  <link rel="stylesheet" href="{{url('/Dashboard/js/select.dataTables.min.css')}}">
...
<body>
      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{url('/Dashboard/images/logo.svg')}}" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="{{url('/Dashboard/images/logo-mini.svg')}}" alt="logo" />
          </a>
        </div>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><span class="text-black fw-bold">M Saqib</span></h1>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown"> 
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{url('/Dashboard/images/faces/face10.jpg')}}" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{url('/Dashboard/images/faces/face12.jpg')}}" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{url('/Dashboard/images/faces/face1.jpg')}}" alt="image" class="img-sm profile-pic">
                </div>
                <div class="preview-item-content flex-grow py-2">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="{{url('/Dashboard/images/faces/face8.jpg')}}" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="{{url('/Dashboard/images/faces/face8.jpg')}}" alt="Profile image">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" style="max-height: 100%" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column ">
                <li class="nav-item"> <a class="nav-link" href="{{url('/Ui/Button')}}">Buttons</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/Ui/Dropdown')}}">Dropdowns</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('/Ui/Typogrphi')}}">Typography</a></li>
              </ul>
            </div>
          </li>

          {{-- _____________________ FormControll for UI  _____________ --}}
          ...
          {{-- _____________________ Chart Controll _____________ --}}
          <li class="nav-item">
  ...
  <script src="{{url('/Dashboard/vendors/chart.js/Chart.min.js')}}"></script>
  <script src="{{url('/Dashboard/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{url('/Dashboard/vendors/progressbar.js/progressbar.min.js')}}"></script>
  ...
  <script src="{{url('/Dashboard/js/jquery.cookie.js')}}" type="text/javascript"></script>
  <script src="{{url('/Dashboard/js/dashboard.js')}}"></script>
  <script src="{{url('/Dashboard/js/Chart.roundedBarCharts.js')}}"></script>
